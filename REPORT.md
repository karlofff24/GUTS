...
**Ожидаемое поведение**: Соник быстро прыгает
**Фактическое поведение**: Соник медленно прыгает
**Серьёзность**: Высокая
...
### Баг № 12
**Описание**: Соник медленно бегает
**Шаги воспроизведения**:  
1. Запустить игру 
2. Бежим
**Ожидаемое поведение**: Соник быстро бежит
**Фактическое поведение**: Соник бежит медленно
**Серьёзность**: Высокая
...
**Описание теста**: Замена файлов фона, спрайта и моста

**Шаги**:  
1. Запустить игру  
2. Нажать пробел и проверить спрайт  
3. Посмотреть на фон и мост

**Результат до исправления**: Не прошел. Фон, спрайт и мост не соответствуют описанию игры
...
**Исправление**: Изменила путь к файлу
...
**Результат после исправления**: Прошел. Фон, мост и спрайт стали соответствовать описанию

 ### Unit-тест: Счет

**Описание теста**: Смена счета

**Шаги**:  
1. Запустить игру  
2. Получить баллы  
3. Обратить внимание на счет

**Результат до исправления**: Не прошел. Счет спустя некоторое время меняется на слово "Score"
...
**Исправление**: "Score" заменила на "Счет"
...
**Результат после исправления**: Прошёл. Всегда отображается "Счет" 
```
